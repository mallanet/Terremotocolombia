...
import { VOLUNTEER_MODELS } from "./registry/volunteer-models";
import { CAMPAIGN_MODELS } from "./registry/campaign-models";
...
export interface ModelConfig {
  ...
  canDelete?: boolean;
  /**
   * Campos que el 201 del alta devuelve UNA sola vez y que no son columnas de
   * la tabla (hoy: el token del responsable de punto). Sin esto el BFF los
   * recortaría y el valor se perdería para siempre, porque el backend solo
   * guarda su hash.
   */
  revealOnCreate?: readonly string[];
}
